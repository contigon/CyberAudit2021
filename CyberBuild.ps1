...
$utilities = @("dotnet-sdk","Net_Framework_Installed_Versions_Getter","python27","python38","openjdk","putty","winscp","npcap","nmap-portable","rclone","everything","VoidToolsCLI","notepadplusplus","googlechrome","firefox","foxit-reader","irfanview","grepwin","sysinternals","snmpget","wireshark")
